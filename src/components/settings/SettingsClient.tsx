        ...
        <div className="bg-surface-container-lowest rounded-3xl clay-card p-6 border border-outline-variant/10">
          <div className="flex items-center justify-between gap-4">
            ...
            <a
              ...
              className="px-3 sm:px-6 h-12 rounded-2xl bg-surface-container hover:bg-surface-container-high flex items-center justify-center gap-3 transition-all group"
            ...
            >
              ...
              <span className="hidden sm:inline font-bold text-on-surface-variant group-hover:text-primary transition-colors">StudyHive</span>
            </a>
          </div>
        </div>
      </section>
